...
export function Gym() {
    ...
    const upcoming = useMemo(() => productivity.workouts.filter((workout) => workout.date >= today).sort((a, b) => `${a.date}${a.startTime}`.localeCompare(`${b.date}${b.startTime}`)), [productivity.workouts, today]);
